...
$sql='select time,buttoncode,accuracy,tag,ip,provider,latitude,longitude from PositionLog WHERE keyid="'.$keyEscaped.'" AND buttoncode=10 ORDER BY time DESC LIMIT '.$start_from.','.$limit.'';
...
echo "<hr noshade class=\"thin\">
      ...
      <div id=\"content\">
	<h1>Punti distribuiti campagna $key<br/></h1></b>
