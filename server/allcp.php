...
$sql='select time,buttoncode,accuracy,tag,ip,provider,latitude,longitude from PositionLog WHERE keyid="'.$keyEscaped.'" AND buttoncode=30 ORDER BY time DESC LIMIT '.$start_from.','.$limit.'';
...
echo '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
     ...
     <title>Cassette pubblicitarie</title>
...
echo "<hr noshade class=\"thin\">
      ...
      <div id=\"content\">
	<h1>Cassette pubblicitarie campagna $key<br/></h1></b>
	<div style=\"color: PaleGoldenrod;\"><a href=\"all.php?key=$key&tag=$tag\">Totale punti</a> $numbertot</div>
